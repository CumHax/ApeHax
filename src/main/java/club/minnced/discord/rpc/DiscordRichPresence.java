...
public class DiscordRichPresence extends Structure {
	private static final List<String> FIELD_ORDER = Collections.unmodifiableList(Arrays.asList("state", "details",
			"startTimestamp", "endTimestamp", "largeImageKey", "largeImageText", "smallImageKey", "smallImageText",
			"partyId", "partySize", "partyMax", "matchSecret", "joinSecret", "spectateSecret", "instance"));
	...
	/**
	 * Unix timestamp (seconds) for the start of the game. <br>
	 * Example: 1507665886
	 */
	...
	/**
	 * Name of the uploaded image for the large profile artwork. <br>
	 * Example: "default"
	 * 
	 * <p>
	...
	/**
	 * Tooltip for the largeImageKey. <br>
	...
	/**
	 * Name of the uploaded image for the small profile artwork. <br>
	 * Example: "rogue"
	 * 
	 * <p>
	 * <b>Maximum: 32 characters</b>
	...
	/**
	 * Tooltip for the smallImageKey. <br>
	...
	/**
	 * ID of the player's party, lobby, or group. <br>
	...
	/**
	 * Current size of the player's party, lobby, or group. <br>
	 * Example: 1
	 */
	public int partySize;

	/**
	 * Maximum size of the player's party, lobby, or group. <br>
	 * Example: 5
	 */
	public int partyMax;

	/**
	 * Unique hashed string for Spectate and Join. Required to enable match
	 * interactive buttons in the user's presence. <br>
	...
	/**
	 * Unique hashed string for Spectate button. This will enable the "Spectate"
	 * button on the user's presence if whitelisted. <br>
	...
	/**
	 * Unique hashed string for chat invitations and Ask to Join. This will enable
	 * the "Ask to Join" button on the user's presence if whitelisted. <br>
